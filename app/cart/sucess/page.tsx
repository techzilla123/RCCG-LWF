...
export default function Home() {
  ...
  // Allow both /cart/success and /cart/sucess
  const isSuccessPage =
    pathname.includes("/cart/success") || pathname.includes("/cart/sucess");

  if (!isSuccessPage) {
    return null; // or return some fallback/404
  }
      ...
      <div className="flex flex-1 justify-center items-center">
        <main className="flex flex-col py-10 max-w-[539px] w-full">
          ...
          <section className="flex flex-col items-center text-center mt-6">
            <h1 className="text-4xl text-black">Payment successful!</h1>
