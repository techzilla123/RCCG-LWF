...
export const GetConnected: React.FC = () => {
  return (
    <main className="box-border flex flex-col items-center px-10 pt-12 pb-28 w-full bg-white min-h-[858px]
      max-md:px-6 max-md:pt-10 max-md:pb-20 max-sm:px-4 max-sm:pt-5 max-sm:pb-16">
      ...
      <div className="flex flex-col items-center w-full max-w-[1080px] mx-auto">
        ...
        <div className="flex items-start w-full gap-10 mt-10 max-md:flex-col max-md:gap-6">
          <RootedSection />
          <div className="flex flex-col gap-12 items-start flex-1 min-h-px max-md:gap-8 w-full">
            <ConnectItem
              icon={<PlayIcon />}
