...
const Offers: React.FC = () => {
  ...
  return (
   <section
  className="flex overflow-hidden flex-col justify-center items-center self-stretch px-32 text-xl tracking-normal leading-8 text-center text-white bg-yellow-400 max-md:px-5"
  style={{ color: "white" }} // keep text white except inputs
>
  <style>
    {`
      section input {
