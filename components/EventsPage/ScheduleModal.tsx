...
export const ScheduleModal: React.FC<ScheduleModalProps> = ({ event, onClose }) => {
  ...
  <p className="text-lg font-semibold text-stone-950 whitespace-normal break-words leading-snug">
    {event.recurring
