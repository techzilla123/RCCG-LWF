...
const LeftSection = () => (
  <div className="flex flex-wrap flex-1 shrink gap-3 h-full basis-0 min-w-[240px] max-md:max-w-full">
    <Link href="/dashboard/payments" passHref>
      <button
        className="flex gap-2.5 items-center p-2 my-auto w-9 h-9 rounded-lg bg-black bg-opacity-0"
        aria-label="Go to Payments Dashboard"
      >
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/44ca6774a1ba2f7faf97318edea0099f748390829095236d8983b05f1d5c48e0?placeholderIfAbsent=true&apiKey=487312638bbb418aa183126fc9624772"
          alt=""
