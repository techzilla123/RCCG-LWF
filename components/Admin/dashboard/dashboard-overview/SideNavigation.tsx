  ...
  return (
    <nav className="p-4 bg-white min-h-screen w-[200px]"> 
      ...
      <div className="overflow-hidden flex-1 mt-4 w-full">
        ...
        <ul className="mt-3 space-y-3">
          <li>
            <a
              ...
              className="flex gap-6 w-full rounded-lg bg-stone-200 min-h-10"
            >
              <div className="flex flex-1 gap-2 items-center px-4">
                <img src="https://cdn.builder.io/api/v1/image/assets/1662cc7878a14807a495bf21efd1ec7c/1b536fd8b76761c316711b689bc728e37a133571?placeholderIfAbsent=true" alt="" className="w-4 h-4" />
        ...
        <ul className="mt-3">
          <li>
            <a href="/admin-settings" className="flex gap-6 w-full rounded-lg min-h-10">
              <div className="flex flex-1 gap-2 items-center px-4">
