...
export default function WishHeader() {
  ...
  const breadcrumbItems = [
    ...
    { label: "Birthday", isActive: false },
  ];

  return (
    <header className="flex overflow-hidden relative flex-col justify-center items-start px-6 py-10 bg-[#FAF6FF] max-md:px-5 max-md:max-w-full">
      <img
        src="/bg-right(1).svg"
        alt=""
        role="presentation"
      ...
      <img
        src="https://cdn.builder.io/api/v1/image/assets/8508077b32c64a2d81a17cc6a85ba436/820273883dccc07e6ccf51b92f28b01e4367aee5?placeholderIfAbsent=true"
        alt=""
        role="presentation"
