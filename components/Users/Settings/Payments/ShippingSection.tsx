...
const citiesByState: { [key: string]: string[] } = {
  ...
  options={statesUSA}  // Use the array directly since it's already in {label, value} format
...
/>
  ...
  value={zipCode}
  onChange={(value) => setZipCode(value)} // <-- pass value directly, not event
/>
        ...
        <FormInput
          ...
          value={address}
           onChange={(value) => setAddress(value)} // <-- pass value directly, not event
        />
