...
import { Breadcrumbs } from "./Wish/Breadcrumbs";
...
export default function WishHeader() {
  ...
  return (
    <header className="flex overflow-hidden relative flex-col justify-center items-start px-6 py-10 bg-stone-50 max-md:px-5 max-md:max-w-full">
      <img
        src="https://cdn.builder.io/api/v1/image/assets/8508077b32c64a2d81a17cc6a85ba436/24387c9ff10c4e460666ea87b7b768479b4014eb?placeholderIfAbsent=true"
        alt=""
        role="presentation"
      ...
      <img
        src="https://cdn.builder.io/api/v1/image/assets/8508077b32c64a2d81a17cc6a85ba436/7c1cfad9a6adbdb165ffb19ac1bf6c80ab5488f1?placeholderIfAbsent=true"
        alt=""
        role="presentation"
