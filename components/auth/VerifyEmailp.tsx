...
import { BackButton } from "./Verifyp/BackButton";
import { VerificationInput } from "./Verifyp/VerificationInput";
import { ActionButtons } from "./Verifyp/ActionButtons";

export const VerifyEmailp: React.FC = () => {
