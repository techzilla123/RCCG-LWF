      ...
      >
        ...
        <span className="flex gap-2.5 justify-center items-center self-stretch my-auto w-5">
          <img
            src={
              isOpen
                ? "https://cdn.builder.io/api/v1/image/assets/8508077b32c64a2d81a17cc6a85ba436/9427faf66673e4569f04d609029152f1e6030a8b?placeholderIfAbsent=true"
                : "https://cdn.builder.io/api/v1/image/assets/8508077b32c64a2d81a17cc6a85ba436/259e787f127dbee6d284057d984923a32c885495?placeholderIfAbsent=true"
            }
